           ...
           if ( enemyType == "Water" )
            {
             ...
             /**
              * TODO (42): Show text that states the attack was very effective at a x location of half the width of the world 
              * and a y location of half the height of the world plus 26 pixels
              */
             getWorld().showText(" This attack was very effective ",  getWorld().getWidth()/2, getWorld().getHeight()/2+26);
