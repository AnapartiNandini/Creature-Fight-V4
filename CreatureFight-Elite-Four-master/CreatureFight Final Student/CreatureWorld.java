...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        for( int k = 0; playerOneLose == true & k < playerOneCreatures.length; k++)
        {
            //TODO (177): If the player one creature at the current index of the array's current health is greater than 0...
            if(playerOneCreatures[k].getHealthBar().getCurrent() > 0)
            {
        ...
        for(int l = 0; playerTwoLose == true & l < playerTwoCreatures.length; l++)
        {
            //TODO (180): If the player two creature at the current index of the array's current health is greater than 0...
            if(playerTwoCreatures[l].getHealthBar().getCurrent() > 0)
            {
     ...
     */
    /**
     * changePlayerOne causes player one's menu to changed. This method will be accessed by other classes 
     * 
     * @param Has a string parameter called creature
     * @return Nothing is returned
     */
    
    public void changePlayerOne(String creature)
    {
        //Set the playerOneCreature variable to creature
        playerOneCreature = creature;
        
        //Remove player one's fight menu
        removeObject(oneFightMenu);
        
        //Remove player one's switch menu
        removeObject(oneSwitchMenu);
        
        //Set the playerOneMenusAdded variable to reflect that there are no player one menus anymore
        playerOneMenusAdded = false;
    }
    /**
     ...
     */
    /**
     * changePlayerOne causes player two's menu to changed. This method will be accessed by other classes 
     * 
     * @param Has a string parameter called creature
     * @return Nothing is returned
     */
    ...
    {
        //Set the playerTwoCreature variable to creature
        playerTwoCreature = creature;
        
        //Remove player two's fight menu
        removeObject(twoFightMenu);
        
        //Remove player two's switch menu
        removeObject(twoSwitchMenu);
        
        //Set the playerTwoMenusAdded variable to reflect that there are no player one menus anymore
        playerTwoMenusAdded = false;
    }
    /**
    ...
    /**
     * getNewOneCreature get a new OneCreature. This method will be accessed by other classes.
     * 
     * @param Has an integer parameter called index which represents the index.
     * @return A Creature object is returned
     */
    ...
    /**
     * getNewTwoCreature get a new OneCreature. This method will be accessed by other classes.
     * 
     * @param Has an integer parameter called index which represents the index.
     * @return A Creature object is returned
     */
