...
public class Pidgeot extends Creature
{
    ...
    public void attack(int idx)
    {
        ...
        else
        {
            ...
            if(enemyType == "Grass")
            {
                //TODO (115): The enemy only receives two times 55 points of damage. DON'T DO THE MATH! Just type the mathematical expression you would use
                enemy.getHealthBar().add(2*55);
                
                /**
                 * TODO (116): Show text that states the attack was super effective at a x location of half the width of the world 
            ...
            {
                //This enemy receives 55 points of damage
